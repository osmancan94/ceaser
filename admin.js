...
async function loadTableSettings() {
    ...
    // MASA AYAR BUTONUNU AÇAN KOD (Eksik olan bu!)
...
if (saveTableCountBtn) {
    saveTableCountBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            showNotification('Masalar yeniden oluşturuldu', 'success');
    ...
    onSnapshot(query(collection(db, 'tables'), orderBy('number', 'asc')), (snapshot) => {
        ...
        pageTables.forEach(table => {
            const card = createElement('div', {
                ...
                style: `padding:20px; margin:12px; border-radius:15px; background:${table.status === 'Dolu' ? '#e53e3e' : '#10b981'}; color:white; cursor:pointer; text-align:center; min-width:120px; display:inline-block;`,
